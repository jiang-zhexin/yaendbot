/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 63d850765b96c8f640321cef9e3b02ef)
// Runtime types generated with workerd@1.20250803.0 2025-08-09 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		BOT_INFO: {"id":7913290545,"is_bot":true,"first_name":"yaendbot","username":"yaendbot","can_join_groups":true,"can_read_all_group_messages":true,"supports_inline_queries":false,"can_connect_to_business":false,"has_main_web_app":false};
		BOT_TOKEN: string;
		secret_token: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BOT_INFO" | "BOT_TOKEN" | "secret_token" | "AI_GATEWAY_API_KEY" | "WEBHOOK">> {}
}
